...
export interface VODCategoryListProps {
...
export interface VODCategoryItemProps {
...
/**
 * VODCategoryItem - A single focusable category item in the list.
 */
function VODCategoryItem({
  category,
  isSelected,
  onSelect,
  testId,
}: VODCategoryItemProps) {
  const { ref, focused } = useFocusable({
    focusKey: `VOD_CATEGORY_${category.id}`,
...
/**
 * VODCategoryList - Vertical list of VOD categories with spatial navigation.
 *
 * Features:
 ...
 */
export function VODCategoryList({
  categories,
  selectedCategoryId,
  onCategorySelect,
  testId,
}: VODCategoryListProps) {
  const { ref, focusKey } = useFocusable({
    focusKey: 'VOD_CATEGORY_LIST',
